        ...
        <div className="flex items-center gap-[1px] sm:gap-0.5 flex-1 justify-center min-w-0">
          {shortMonths.map((m, i) => (
            <motion.button
              ...
              className={`text-[7px] sm:text-[11px] px-[3px] sm:px-2.5 py-0.5 sm:py-1.5 rounded-lg font-semibold transition-colors duration-200 whitespace-nowrap flex-shrink-0 relative ${i + 1 === selectedMonth
